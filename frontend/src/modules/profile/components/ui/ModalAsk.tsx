...
const ModalAsk: React.FC<ModalProps> = ({ isOpen, onClose, onConfirm, title, message }) => {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center z-50">
            ...
            {/* Modal content */}
            <div className="bg-white rounded-3xl justify-center border-2 border-dark-blue p-8 shadow-lg z-60 relative w-[30%] h-[33%]">
                <h2 className="text-relative-h4 font-kharkiv mb-4 text-center">{title}</h2>
