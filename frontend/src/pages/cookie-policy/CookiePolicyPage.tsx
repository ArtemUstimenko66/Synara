	...
	return (
		<Wrapper>
			...
			<div className="min-h-screen mt-24 ml-[3%] mr-[3%] font-montserratRegular text-black">
				<h1 className={`text-h2 font-kharkiv mb-8 ${animationFadeIn}`}>Політика використання cookie</h1>
				...
				<div className="space-y-10 text-lg leading-relaxed">
					...
					<section className={`${animationSlideIn} delay-200`}>
						<h2 className="text-h3 font-semibold mb-4">2. Що таке кукі?</h2>
						<p>
					...
					<section className={`${animationSlideIn} delay-300`}>
						<h2 className="text-h3 font-semibold mb-4">3. Чому ми використовуємо кукі?</h2>
						<p>
					...
					<section className={`${animationSlideIn} delay-400`}>
						<h2 className="text-h3 font-semibold mb-4">4. Які типи кукі ми використовуємо?</h2>
						<p>
					...
					<section className={`${animationSlideIn} delay-500`}>
						<h2 className="text-h3 font-semibold mb-4">5. Як керувати кукі?</h2>
						<p>
					...
					<section className={`${animationSlideIn} delay-600`}>
						<h2 className="text-h3 font-semibold mb-4">6. Зміни до політики кукі</h2>
						<p>
