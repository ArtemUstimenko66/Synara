        ...
        <div className="w-full relative">
            <Wrapper>
                ...
                <div className="relative z-10 flex flex-col items-center justify-center pt-2">
                    ...
                    <section className='w-full flex justify-center sm:mt-96 sm:bg-dark-blue flex-col xl:flex-row md:flex-row xl:mt-[20vw] md:mt-[11vw] '>
                        <div
                            ...
                            <div className="flex-1 flex flex-col xl:ml-6 md:ml-6">
                                ...
                                <div
                                    ...
                                    <div className="flex items-center">
                                        <VectorBlue className="xl:w-10 xl:h-10 md:w-10 md:h-10 sm:w-10 sm:h-10 sm:mr-4 md:mr-0 xl:mr-0"/>
                                        <p className="xl:ml-8 md:ml-4 sm:text-xs-ps font-montserratRegular xl:text-pl md:text-relative-pxl">Перевірені волонтери: Ми ретельно перевіряємо кожного волонтера, щоб забезпечити вашу безпеку та довіру.</p>
                                    </div>
                                    <div className="flex items-center">
                                        <VectorBlue className="xl:w-10 xl:h-10 md:w-10 md:h-10 sm:w-10 sm:h-10 sm:mr-4 md:mr-0 xl:mr-0"/>
                                        <p className="xl:ml-8 md:ml-4 sm:text-xs-ps font-montserratRegular xl:text-pl md:text-relative-pxl">Швидкий пошук допомоги: Зручні фільтри та інтуїтивний інтерфейс допоможуть швидко знайти потрібну допомогу.</p>
                                    </div>
                                    <div className="flex items-center">
                                        <VectorBlue className="xl:w-8 xl:h-8 md:w-8 md:h-8 sm:w-8 sm:h-8 sm:mr-4 md:mr-0 xl:mr-0"/>
                                        <p className="xl:ml-8 md:ml-4 sm:text-xs-ps font-montserratRegular xl:text-pl md:text-relative-pxl">Прозорість та звітність: Ми відкрито звітуємо про всі зібрані кошти та надану допомогу.</p>
                                    </div>
                                    <div className="flex items-center">
                                        <VectorBlue className="xl:w-10 xl:h-10 md:w-10 md:h-10 sm:w-10 sm:h-10 sm:mr-4 md:mr-0 xl:mr-0"/>
                                        <p className="xl:ml-8 md:ml-4 sm:text-xs-ps font-montserratRegular xl:text-pl md:text-relative-pxl">Зручна комунікація: Спілкуйтеся з волонтерами та іншими користувачами через зручний чат та відеозв'язок.</p>
                                    </div>
                                    <div className="flex items-center">
                                        <VectorBlue className="xl:w-8 xl:h-8 md:w-8 md:h-8 sm:w-8 sm:h-8 sm:mr-4 md:mr-0 xl:mr-0"/>
                                        <p className="xl:ml-8 md:ml-4 sm:text-xs-ps font-montserratRegular xl:text-pl md:text-relative-pxl">Підтримка 24/7: Наша команда завжди готова допомогти вам з будь-якими питаннями.</p>
                                    </div>
                                </div>
                            </div>
